...
contract Token is Ownable, ERC20 {
    ...
    uint public firstMint_Date_TimeStamp = timestampFromDateTime(2022, 2, 16, 21, 6, 1);
    bool public firstMint_Sent = false;
    uint public secondMint_Date_TimeStamp = timestampFromDateTime(2022, 3, 16, 21, 6, 1);
    bool public secondMint_Sent = false;
    uint public thirdMint_Date_TimeStamp = timestampFromDateTime(2022, 4, 16, 21, 6, 1);
    bool public thirdMint_Sent = false;
    uint public fourthMint_Date_TimeStamp = timestampFromDateTime(2022, 5, 16, 21, 6, 1);
    ...
    constructor () {
        ...
        _mint(_msgSender(), _initialSupply.div(2));
        _mint(address(this), _initialSupply.div(2));
    }
    /* EXCLUSIVE FUNCTIONS */
